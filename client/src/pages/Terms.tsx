...
export default function Terms() {
  ...
  return (
    <>
      ...
      >
        <h1 className="text-[2.25rem] sm:text-5xl md:text-[3.5rem] leading-[1.05] font-serif font-bold tracking-[-0.02em] text-foreground heading-rule-left">Terms of Service</h1>
      ...
      <Section measure="prose" rhythm="tight" className="overflow-hidden pb-[clamp(3.25rem,6vw,5.5rem)]">
        ...
        <div className="prose prose-neutral dark:prose-invert max-w-none space-y-8 text-[0.95rem] leading-relaxed text-muted-foreground">
          <section>
            <h2 className="text-[1.25rem] sm:text-[1.375rem] font-serif font-bold text-foreground mb-3">Agreement to Terms</h2>
          ...
          <section>
            <h2 className="text-[1.25rem] sm:text-[1.375rem] font-serif font-bold text-foreground mb-3">Services</h2>
          ...
          <section>
            <h2 className="text-[1.25rem] sm:text-[1.375rem] font-serif font-bold text-foreground mb-3">Scheduling & Cancellations</h2>
          ...
          <section>
            <h2 className="text-[1.25rem] sm:text-[1.375rem] font-serif font-bold text-foreground mb-3">Payment</h2>
          ...
          <section>
            <h2 className="text-[1.25rem] sm:text-[1.375rem] font-serif font-bold text-foreground mb-3">Satisfaction Guarantee</h2>
          ...
          <section>
            <h2 className="text-[1.25rem] sm:text-[1.375rem] font-serif font-bold text-foreground mb-3">Liability</h2>
          ...
          <section>
            <h2 className="text-[1.25rem] sm:text-[1.375rem] font-serif font-bold text-foreground mb-3">Website Use</h2>
          ...
          <section>
            <h2 className="text-[1.25rem] sm:text-[1.375rem] font-serif font-bold text-foreground mb-3">Changes to Terms</h2>
